        ...
        <div class="login-panel">
            ...
            <div class="form">
                ...
                <p>
                    <span>账号登录</span>
                    <el-input 
                    :class="{error: error && !userName}" v-model="userName" 
                    placeholder="手机号/用户名/邮箱" prefix-icon="profile"></el-input>
                    <el-input 
                    :class="{error: error && !password}" v-model="password" 
                    type="password" placeholder="密码"  prefix-icon="password"></el-input>
                </p>
                <div class="foot">
                    <a href="">忘记密码?</a>
                </div>
