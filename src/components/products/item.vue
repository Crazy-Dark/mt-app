    ...
    <dl class="s-item">
        ...
        <dd>
            ...
            <p>
                ...
                <span v-else>差</span>
                <span class="s-item-price">{{meta.score}}分</span>
                <span class="s-item-comment-total">{{meta.commentNum}}人评论</span>
            </p>
            <p>
                <span class="s-item-tab">
                    <span class="" v-for="(v, i) in meta.tab" :key="i">{{v + (i < meta.tab.length - 1 ? '|' : '')}}</span>
                </span>
            ...
            <ul class="deal-items">
                <li class="items" 
                v-for="(item, index) in meta.dealItems.slice(0, 2)" :key="index">
                <p class="deal-title">
                    {{item.title}}
                </p>
                <p>
